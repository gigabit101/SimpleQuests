...
public class SimpleQuestsFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        CONTEXT_MULTIPLIER = Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(SimpleQuests.MODID, "context_multiplier"), new LootNumberProviderType(QuestNumberProvider.ContextMultiplierNumberProvider.CODEC));
    }
